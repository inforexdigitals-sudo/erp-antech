      ...
      if (claim.items.length > 0) {
        y = drawTable(
          ...
          [
            ...
            { header: 'Description', width: pageWidth * 0.23 },
            { header: 'Qty', width: pageWidth * 0.1, align: 'right' },
            { header: 'Unit Price', width: pageWidth * 0.13, align: 'right' },
            { header: 'Previous %', width: pageWidth * 0.12, align: 'right' },
            { header: 'This Claim %', width: pageWidth * 0.12, align: 'right' },
            { header: 'Cumulative %', width: pageWidth * 0.12, align: 'right' },
            { header: 'Amount', width: pageWidth * 0.12, align: 'right' },
          ],
          claim.items,
          (item, i) => [
            String(i + 1),
