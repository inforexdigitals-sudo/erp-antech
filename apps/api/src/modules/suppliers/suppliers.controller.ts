...
export class SuppliersController {
  ...
  list(@CurrentUser() user: AuthenticatedUser, @Query() query: QuerySuppliersDto) {
    return this.suppliers.list(user.companyId, query);
  }
  ...
  update(
    ...
    return this.suppliers.update(user.companyId, id, user.userId, dto);
  }
  ...
  remove(@CurrentUser() user: AuthenticatedUser, @Param('id', ParseUUIDPipe) id: string) {
    return this.suppliers.remove(user.companyId, id, user.userId);
  }
}
